	...
	*******************************************************************/
	...
	if ( isset($_POST['submit']) ) {
		if ( !current_user_can('manage_options') )
			...
			update_option('easypaypal_test', $epp_test );
			$epp_payment_email  = $_POST['epp_payment_email'];
			update_option('easypaypal_payment_email', $epp_payment_email );
			$epp_return_URL = $_POST['epp_return_URL'];
			update_option('easypaypal_return_URL', $epp_return_URL );
			$epp_item_name = $_POST['epp_item_name'];
			update_option('easypaypal_item_name', $epp_item_name );
			$epp_item_number = $_POST['epp_item_number'] + "";
			update_option('easypaypal_item_number', $epp_item_number );
			update_option('easypaypal_amount', "" );
			$epp_amount = $_POST['epp_amount'];
			$epp_amount = number_format($epp_amount,2,".","");
			update_option('easypaypal_amount', $epp_amount );
			$epp_currency_code = $_POST['epp_currency_code'];
			update_option('easypaypal_currency_code', $epp_currency_code );
			$epp_days_to_add = $_POST['epp_days_to_add'];
			update_option('easypaypal_days_to_add', $epp_days_to_add );
			$epp_trial = $_POST['epp_trial'];
			update_option('easypaypal_trial', $epp_trial );
			$epp_auth_code = $_POST['epp_auth_code'];
			update_option('easypaypal_auth_code', $epp_auth_code );
			$epp_user_msg = $_POST['epp_user_msg'];
			update_option('easypaypal_user_msg', $epp_user_msg );
			$epp_bypass = $_POST['epp_bypass'];
			update_option('easypaypal_bypass', $epp_bypass );
			$epp_categories = $_POST['epp_categories'];
			update_option('easypaypal_categories', $epp_categories );
			$epp_more_login = $_POST['epp_more_login'];
			update_option('easypaypal_more_login', $epp_more_login );
			$epp_category_payment_page = $_POST['epp_category_payment_page'];
			update_option('easypaypal_category_payment_page', $epp_category_payment_page );
			$epp_post_payment_page = $_POST['epp_post_payment_page'];
			update_option('easypaypal_post_payment_page', $epp_post_payment_page );			
			$epp_subscription_payment_page = $_POST['epp_subscription_payment_page'];
			update_option('easypaypal_subscription_payment_page', $epp_subscription_payment_page );			
		}
		else {
			//Set Defaults
			$epp_bypass  = get_option('easypaypal_bypass');
			...
			$epp_currency_code  = get_option('easypaypal_currency_code');
			if(strlen($epp_currency_code) == 0) {
			   $epp_currency_code = "USD";
			   update_option('easypaypal_currency_code', $epp_currency_code );
			}
			$epp_user_msg = get_option('easypaypal_user_msg');
			...
			$epp_subscription_payment_page = get_option('easypaypal_subscription_payment_page');
			if(strlen($epp_subscription_payment_page) == 0) {
			   $epp_subscription_payment_page = "[pay]";
			   update_option('easypaypal_subscription_payment_page', $epp_subscription_payment_page);
			}
			$epp_post_payment_page = get_option('easypaypal_post_payment_page');
			if(strlen($epp_post_payment_page) == 0) {
			   $epp_post_payment_page = "[Payment Options]";
			   update_option('easypaypal_post_payment_page', $epp_post_payment_page);
			}			
			$epp_category_payment_page = get_option('easypaypal_category_payment_page');
...
<div class="wrap">
<h2><?php _e('EasyPayPal Configuration'); ?></h2>
	<p><?php printf(__('Configure EasyPalPal below.&nbsp;&nbsp;For help, see the <a href="http://www.voiceoftech.com/swhitley/index.php/?page_id=129">support page</a>')); ?></p>
<h3>&#x0bb; <a href="options-general.php?page=easypaypal/easypaypal_users.php">User Manager</a></h3>
<form action="" method="post" id="EasyPayPal-Conf" style="margin: 0; width: 100%; ">
<p><input id="epp_test" name="epp_test" type="checkbox" value="checked" <?php echo get_option('easypaypal_test'); ?> />&nbsp;&nbsp;<label for="epp_test">
...
<td><input id="epp_auth_code" name="epp_auth_code" type="text" size="30" maxlength="30" value="<?php echo get_option('easypaypal_auth_code'); ?>"  /></td>
...
<td><input id="epp_payment_email" name="epp_payment_email" type="text" size="30" maxlength="50" value="<?php echo get_option('easypaypal_payment_email'); ?>"  /> </td>
...
<td><input id="epp_item_name" name="epp_item_name" type="text" size="30" maxlength="150" value="<?php echo get_option('easypaypal_item_name'); ?>"  /> </td>
...
<td><input id="epp_item_number" name="epp_item_number" type="text" size="10" maxlength="30" value="<?php echo get_option('easypaypal_item_number'); ?>"  /> </td>
...
<td><input id="epp_amount" name="epp_amount" type="text" size="10" maxlength="10" value="<?php echo get_option('easypaypal_amount'); ?>"  /> </td>
...
<td><input id="epp_currency_code" name="epp_currency_code" type="text" size="3" maxlength="3" value="<?php echo get_option('easypaypal_currency_code'); ?>"  /> </td>
...
<td><input id="epp_days_to_add" name="epp_days_to_add" type="text" size="4" maxlength="4" value="<?php echo get_option('easypaypal_days_to_add'); ?>"  /> </td>
...
<td><input id="epp_trial" name="epp_trial" type="text" size="4" maxlength="4" value="<?php echo get_option('easypaypal_trial'); ?>"  /> </td>
...
<td><textarea id="epp_user_msg" name="epp_user_msg" rows=5 cols=30 ><?php echo get_option('easypaypal_user_msg'); ?></textarea></td>
...
<td><textarea id="epp_more_login" name="epp_more_login" rows=5 cols=30 ><?php echo get_option('easypaypal_more_login'); ?></textarea></td>
...
<td><textarea id="epp_bypass" name="epp_bypass" rows=5 cols=30  ><?php echo get_option('easypaypal_bypass'); ?></textarea></td>
...
<td><textarea id="epp_categories" name="epp_categories" rows=5 cols=30  ><?php echo get_option('easypaypal_categories'); ?></textarea></td>
...
<td><input id="epp_subscription_payment_page" name="epp_subscription_payment_page" size="30" maxlength="150" value="<?php echo get_option('easypaypal_subscription_payment_page'); ?>"></td>
...
<td><input id="epp_post_payment_page" name="epp_post_payment_page" size="30" maxlength="150" value="<?php echo get_option('easypaypal_post_payment_page'); ?>"></td>
...
<td><input id="epp_category_payment_page" name="epp_category_payment_page" size="30" maxlength="150" value="<?php echo get_option('easypaypal_category_payment_page'); ?>"></td>
