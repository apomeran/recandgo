...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54383797859576_94460459',
  'has_nocache_code' => false,
  'cache_lifetime' => 31536000,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54383797859576_94460459')) {function content_54383797859576_94460459($_smarty_tpl) {?><div id="search_block_top_content" class="col-xs-12 col-sm-3 col-sm-pull-6 disable_center "><div id="search_block_top"><form method="get" action="http://recandgo.com/shop/en/buscar" id="searchbox"><label for="search_query_top"></label> <input type="hidden" name="controller" value="search" /> <input type="hidden" name="orderby" value="position" /> <input type="hidden" name="orderway" value="desc" /> <input class="search_query form-control" type="text" id="search_query_top" name="search_query" placeholder="Search" value="" /> <button type="submit" name="submit_search" class="button-search"> <span>Search</span> </button></form></div></div><?php }} ?>
